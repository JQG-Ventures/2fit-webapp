...
exercise_model = api.model('Exercise', {
    ...
    'muscle_group': fields.List(fields.String, required=True, description='Target muscle groups'),
    'difficulty': fields.String(default="Beginner", description='Exercise difficulty level'),
    'equipment': fields.List(fields.String, default=["body_weight"], description='Required equipment'),
...
class BulkExerciseResource(Resource):
    ...
    def post(self):
        ...
        try:
            ...
            return {"status": "success", "message": {"exercise_ids": exercise_ids}}, 201
        except ValidationError as err:
