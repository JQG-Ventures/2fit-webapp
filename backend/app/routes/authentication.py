...
notifications_model = api.model('Notifications', {
...
settings_model = api.model('Settings', {
    ...
    'nutrition_enabled': fields.Boolean(default=False, description='Nutrition tracking enabled'),
    'language_preference': fields.String(default='es', description='Language preference')
})

automation_data_model = api.model('AutomationData', {
...
training_preferences_model = api.model('TrainingPreferences', {
    'preferred_muscle_groups': fields.List(fields.String, description='Preferred muscle groups'),
...
user_registration_model = api.model('UserRegistration', {
    ...
    'auth_provider': fields.String(default="default", description='Which authentication method', enum=["default", "google", "meta", "apple"]),
...
google_login_model = api.model('Google Login', {
    'email': fields.String(description='Email address')
})
