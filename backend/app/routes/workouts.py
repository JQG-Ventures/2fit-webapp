...
workout_schedule_model = api.model('WorkoutSchedule', {
...
workout_plan_model = api.model('WorkoutPlan', {
    ...
    'plan_type': fields.String(required=True, description='Type of workout plan',
    ...
    'workout_schedule': fields.List(fields.Nested(workout_schedule_model), required=True, description='Workout schedule'),
    'level': fields.String(default="beginner", description='Level of difficulty',
                           enum=['beginner', 'intermediate', 'advanced']),
})

save_workouts_model = api.model('SaveWorkouts', {
...
class BulkWorkoutPlanResource(Resource):
    ...
    def post(self):
        ...
        try:
            ...
            return {"status": "success", "message": {"workout_plan_ids": workout_plan_ids}}, 201
        except ValidationError as err:
...
class UserWorkoutSavedResource(Resource):
    ...
    def delete(self):
        ...
        try:
            ...
            return {"status": "error", "message": "There was an error removing the saved workout!"}, 400
        except Exception as e:
            logging.exception(str(e))
            return {"status": "error", "message": str(e)}, 500
...
class ChallengeProgressResource(Resource):
    ...
    def get(self):
        ...
        try:
            ...
            if not challenge_id:
                return {'status': 'error', 'message': 'Missing required parameter: challenge_id'}, 400
...
class DeleteExercisesResource(Resource):
    ...
    def put(self, plan_id):
        ...
        try:
            ...
            return {"status": "error", "message": "Workout Plan not found or no exercises deleted"}, 404
        except Exception as e:
            logging.exception(str(e))
            return {"status": "error", "message": str(e)}, 500
...
class UpdateExercisesResource(Resource):
    ...
    def put(self, plan_id):
        ...
        try:
            ...
            return {"status": "error", "message": "Workout Plan not found or no exercises updated"}, 404
        except Exception as e:
            logging.exception(str(e))
            return {"status": "error", "message": str(e)}, 500
