            ...
            <div className="h-[45%] flex flex-col w-full space-y-6 lg:max-w-3xl">
                ...
                <div className="flex space-x-6 overflow-x-auto pb-4">
                    {cards.map((card) => (
                        <div
                            key={card.id}
                            className={`w-3/4 h-70 flex-shrink-0 rounded-lg shadow-md p-6 cursor-pointer border-2 ${
                                selectedCard === card.id ? 'border-green-600' : 'border-gray-200'
                            }`}
                        ...
                        >
                            <div className="flex flex-col justify-between h-full">
                                <div className="flex justify-end items-center">
                                    ...
                                    {card.kind === 'MasterCard' && (
                                        <BiLogoMastercard className="w-14 h-14" />
                                    )}
