...
import PasswordInput from '@/app/_components/others/PasswordInput';
import { updatePassword } from '@/app/_services/userService';
import SuccessModal from '@/app/_components/modals/SuccessModal';
...
const CreatePasswordScreen: React.FC = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            setApiError(t('ForgotPassword.step3.createPasswordScreen.errorMessages.apiError'));
        } finally {
            setIsSubmitting(false);
        }
    };
