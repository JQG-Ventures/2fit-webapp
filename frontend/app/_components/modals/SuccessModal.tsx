  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
      <div className="bg-white rounded-3xl py-28 px-12 w-[100%] max-w-2xl text-center shadow-2xl relative flex flex-col">
        ...
        <h2 className="text-4xl font-bold mb-6">{t("ForgotPassword.step3.createPasswordScreen.modal.successTitle")}</h2>
        <p className="text-gray-600 mb-10 text-2xl">{t("ForgotPassword.step3.createPasswordScreen.modal.successMessage")}</p>
