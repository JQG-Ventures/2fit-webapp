    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (!newPassword) {
            validationErrors.newPassword =
                t('ChangePasswordModal.passwordRequired') || 'Password is required.';
        ...
        if (!confirmPassword) {
            validationErrors.confirmPassword =
                t('ChangePasswordModal.confirmPasswordRequired') || 'Please confirm your password.';
        ...
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
            ...
            >
                <h2 className="text-4xl font-semibold">
                    {t('ChangePasswordModal.title') || 'Change Password'}
                </h2>
                ...
                <div className="flex flex-col space-y-8 my-16">
                    ...
                    <div className="">
                        <label
                            ...
                            className="block text-2xl text-gray-700 mb-4"
                        >
                ...
                {errorMessage && <p className="text-red-500 text-2xl mb-8">{errorMessage}</p>}
