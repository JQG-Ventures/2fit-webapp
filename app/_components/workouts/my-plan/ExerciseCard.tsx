...
const ExerciseCard: React.FC<ExerciseCardProps> = ({ exercise, onClick, isDeleteMode, isOptionalMode, onDeleteSelect, onOptionalSelect, selectedForDelete }) => (
	<div
		className={`relative bg-white shadow-md rounded-lg overflow-hidden transition-transform transform hover:scale-105 ${exercise.is_completed || selectedForDelete ? "opacity-50 pointer-events-none" : ""
			}`}
	...
	>
		<div className="relative w-full h-40">
			...
			{exercise.is_completed && <div className="absolute top-2 left-2 text-green-500 text-2xl"><FaCheckCircle /></div>}
			{isDeleteMode && (
				<button
